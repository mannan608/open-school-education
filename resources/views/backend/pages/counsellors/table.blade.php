        ...
        <div x-show="showDeleteModal" x-cloak class="fixed inset-0 z-[99999]">
            ...
            <div class="absolute inset-0 flex items-center justify-center p-4">
                <div class="w-full max-w-md rounded-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-xl">
                    <div class="p-5">
                        <div class="text-base font-semibold text-neutral-800 dark:text-white/90">Delete Counsellor?</div>
                        ...
                        <div class="mt-5 flex justify-end gap-3">
                            <button type="button" @click="closeDeleteModal()" class="inline-flex items-center justify-center rounded-lg border border-neutral-300 dark:border-neutral-700 px-4 py-2 text-sm font-medium text-neutral-700 dark:text-neutral-200 hover:bg-neutral-50 dark:hover:bg-neutral-800">Cancel</button>
                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-neutral-50 dark:bg-white/[0.02] border-b border-neutral-100 dark:border-white/[0.05]">
                        <tr>
                            ...
                            <th class="px-5 py-4 text-xs font-medium text-neutral-500 uppercase tracking-wider">Designation</th>
                            <th class="px-5 py-4 text-xs font-medium text-neutral-500 uppercase tracking-wider">Country</th>
                        ...
                        <template x-for="row in tableRowData" :key="row.id">
                            <tr class="hover:bg-neutral-50/50 dark:hover:bg-white/[0.01] transition-colors">
                                <td class="px-5 py-4">
                                    ...
                                    <template x-if="!row.photo_url">
                                        <div class="h-10 w-10 rounded-full bg-neutral-200 flex items-center justify-center text-neutral-500 font-bold">
                                ...
                                <td class="px-5 py-4 text-sm text-neutral-500 dark:text-neutral-400" x-text="row.designation"></td>
                                <td class="px-5 py-4 text-sm text-neutral-500 dark:text-neutral-400" x-text="row.country"></td>
                                ...
                                <td class="px-5 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        <a :href="baseUrl + '/' + row.id + '/edit'" class="p-2 text-neutral-500 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-500/10 rounded-lg transition-all">
