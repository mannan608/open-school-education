...
@section('content')
    <div class="">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
                <h3 class="text-lg font-semibold text-neutral-800 dark:text-white/90">Providers Management</h3>
                <p class="text-sm text-neutral-500 dark:text-neutral-400">Manage your providers.
                </p>
            </div>
