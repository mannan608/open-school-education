...
@section('content')
    <div class="">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div>
                <h3 class="text-lg font-semibold text-neutral-800 dark:text-white/90">Campus Management</h3>
                <p class="text-sm text-neutral-500 dark:text-neutral-400">Manage campuses, logos, and banners.
                </p>
            </div>
