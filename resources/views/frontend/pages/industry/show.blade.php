        ...
        <div class="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-14">
            ...
            <div class="lg:col-span-7">
                ...
                <div
                    ...
                    <span class="flex h-6 w-6 items-center justify-center rounded-full bg-secondary-100">
                        <iconify-icon icon="lucide:award" class="text-sm text-secondary-600"></iconify-icon>
                    </span>
                ...
                <div class="mt-7 flex flex-col gap-3 sm:flex-row">
                    ...
                    <a href="#assessment-form"
                        class="inline-flex items-center justify-center gap-2 rounded-xl bg-secondary-500 px-6 py-3.5 text-sm font-extrabold text-white shadow-md shadow-secondary-500/20 transition hover:bg-secondary-600 hover:shadow-lg">
                    ...
                    <a href="#faq"
                        class="inline-flex items-center justify-center gap-2 rounded-xl border border-brand-200 bg-white px-6 py-3.5 text-sm font-bold text-brand-700 transition hover:border-brand-300 hover:bg-brand-50">
                ...
                <div class="mt-9 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    {{-- Course Info --}}
                    <div
                        class="rounded-2xl border border-brand-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">

                        <div class="flex items-center gap-3">

                            <div
                                class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-brand-100 text-brand-700">
                                <iconify-icon icon="lucide:book-open" class="text-xl"></iconify-icon>
                            </div>

                            <h3 class="text-sm font-extrabold text-brand-950">
                                Key Information
                            </h3>
             ...
             <div class="lg:col-span-5" id="assessment-form">
                    <div class="bg-white text-slate-900 rounded-2xl p-6 sm:p-8 shadow-2xl border border-brand-100 relative">
                        ...
                        <form class="space-y-4">
                            ...
                            <button type="submit"
                                class="w-full py-3.5 px-6 rounded-lg bg-secondary-500 hover:bg-secondary-600 text-white font-extrabold text-sm uppercase tracking-wider transition duration-200 shadow-lg shadow-secondary-500/25">
                                Submit
                            </button>
                        </form>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12">
                ...
                <div class="p-6 sm:p-10 lg:col-span-5 lg:p-12">
                    ...
                    <div
                        ...
                        <div
                            class="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-700 text-white shadow-sm">
                            <iconify-icon icon="lucide:book-open-check" class="text-2xl"></iconify-icon>
                        </div>

                        <span
                            class="mt-6 block text-xs font-black uppercase tracking-[0.18em] text-secondary-600">
                ...
                <div class="flex flex-col justify-center p-6 sm:p-10 lg:col-span-7 lg:p-12">
                    ...
                    <h2 class="mt-3 max-w-2xl text-2xl font-black leading-tight tracking-tight text-brand-950 sm:text-3xl lg:text-4xl">
                        Discover the Full Potential of Open School Education
                    </h2>
                    ...
                    <div class="mt-7">
                        ...
                        <a href="#inquiry-form"
                            class="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-700 px-6 py-3.5 text-sm font-extrabold text-white transition hover:bg-brand-800">
...
<section class="bg-white py-16 sm:py-20">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto max-w-3xl text-center">
            ...
            <h2 class="mt-3 text-2xl font-black tracking-tight text-brand-950 sm:text-3xl lg:text-4xl">
                How Open School Education Works
            </h2>
        ...
        <div class="mt-12 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div
                ...
                <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-700 text-sm font-black text-white">
                    1
                </div>
                ...
                <p class="mt-2 text-sm leading-6 text-slate-500">
                    Start your Open School Education journey with a quick skills check
